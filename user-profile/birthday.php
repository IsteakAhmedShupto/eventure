...
<body>
    ...
    <div class="bg-form-wrapper">
        ...
        <form class="birthday-form" action="./process-event-reg.php" method="POST" novalidate>

            <h3>Hope all your birthday wishes come true!</h3>
            ...
            <div>
                <input type="text" value="Birthday event" name="event" readonly="readonly">
            </div>
